...
class BlackCalibFrame(tkinter.ttk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.scale = tkinter.ttk.Scale(self.adjuster_frame, orient=HORIZONTAL, length=400, from_=0.0, to=128.0, variable=self.scale_var, command=self.scale_change)
...
class RedCalibFrame(tkinter.ttk.Frame):
    def __init__(self, *args, **kwargs):
        tkinter.ttk.Frame.__init__(self, *args, **kwargs)
        ...
        self.scale = tkinter.ttk.Scale(self.adjuster_frame, orient=HORIZONTAL, length=400, from_=0.0, to=383.0, variable=self.scale_var, command=self.scale_change)
        self.canvas_example.grid(row=0, column=0, padx=(10,10), pady=(10,0))
        self.scale.grid(row=2, column=0, pady=(3,0))
        self.scale_change()
