...
class CalibrateMenu(Toplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.instructions_label = tkinter.ttk.Label(self, text="Click on the colors you wish to calibrate.", padding=(0,6,0,9))
        self.calibrate_purpteal_button = tkinter.ttk.Button(self, text="Purple & Teal", takefocus=False, command=self.parent.calib_purpleteal)
        self.calibrate_redblue_button = tkinter.ttk.Button(self, text="Red & Blue", takefocus=False, command=self.parent.calib_redblue)
...
class PurpleCalibFrame(tkinter.ttk.Frame):
    def __init__(self, *args, **kwargs):
        ...
        # lens label
        self.lens_label = tkinter.ttk.Label(self, text="Look through the RED lens", font="Helvetica 16 bold", background="red")

        # canvas example and slider
        self.adjuster_frame = tkinter.ttk.Frame(self)
        ...
        self.scale = tkinter.ttk.Scale(self.adjuster_frame, orient=HORIZONTAL, length=400, from_=0.0, to=255.0, variable=self.scale_var, command=self.scale_change)
        self.canvas_example.grid(row=0, column=0, padx=(10,10), pady=(10,0))
        self.scale.grid(row=2, column=0, pady=(3,0))

        # intstructions label
        self.instructions_label = tkinter.ttk.Label(self, wraplength=400, text="Adjust the slider until the letters disappear. Press 'Next' when finished.")

        # buttons
        self.button_frame = tkinter.ttk.Frame(self)
        self.next_button = tkinter.ttk.Button(self.button_frame, text="Next", takefocus=False, command=self.next_click)
        self.cancel_button = tkinter.ttk.Button(self.button_frame, text="Cancel", takefocus=False, command=self.parent.cancel_click)
...
class TealCalibFrame(tkinter.ttk.Frame):
    def __init__(self, *args, **kwargs):
        tkinter.ttk.Frame.__init__(self, *args, **kwargs)
        ...
        # lens label
        self.lens_label = tkinter.ttk.Label(self, text="Look through the BLUE /GREEN lens", font="Helvetica 16 bold", background="#3232FF")
...
class BlackCalibFrame(tkinter.ttk.Frame):
    def __init__(self, *args, **kwargs):
        tkinter.ttk.Frame.__init__(self, *args, **kwargs)
        ...
        # intstructions label
        self.instructions_label = tkinter.ttk.Label(self, wraplength=400, text="Adjust the slider until the letters disappear. Press 'Finish' when finished.")

        # buttons
        self.button_frame = tkinter.ttk.Frame(self)
        self.finish_button = tkinter.ttk.Button(self.button_frame, text="Finish", takefocus=False, command=self.finish_click)
        self.cancel_button = tkinter.ttk.Button(self.button_frame, text="Cancel", takefocus=False, command=self.parent.cancel_click)
        self.cancel_button.grid(row=0, column=0, padx=(0,6))
