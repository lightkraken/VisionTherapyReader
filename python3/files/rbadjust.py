...
class RBAdjustMenu(Toplevel):
    def __init__(self, parent):
        ...
        self.red_label1 = tkinter.ttk.Label(self.options_frame, text="Bar reader\nColor reader")
        self.red_label2 = tkinter.ttk.Label(self.options_frame, text="Bar 1\nText 1")
        self.red_sep = tkinter.ttk.Label(self.options_frame, text=" : \n : ")
        self.red_button = Button(self.options_frame, background=self.color6, text="    ", command=self.red_click)

        self.blue_label1 = tkinter.ttk.Label(self.options_frame, text="Bar reader\nColor reader")
        self.blue_label2 = tkinter.ttk.Label(self.options_frame, text="Bar 2\nText 2")
        self.blue_sep = tkinter.ttk.Label(self.options_frame, text=" : \n : ")
        ...
        self.black_label2 = tkinter.ttk.Label(self.options_frame, text="Text\nBackground")
        ...
        self.gray_label2 = tkinter.ttk.Label(self.options_frame, text="Background\n ")
        ...
        self.pink_label1 = tkinter.ttk.Label(self.options_frame, text="Bar reader\nColor reader")
        self.pink_label2 = tkinter.ttk.Label(self.options_frame, text=" \nAnchor Text")
        self.pink_sep = tkinter.ttk.Label(self.options_frame, text=" : \n : ")
        ...
        self.red_space = tkinter.ttk.Label(self.options_frame, text=" ", font="Times 3")
        ...
        self.gray_space = tkinter.ttk.Label(self.options_frame, text=" ", font="Times 3")
