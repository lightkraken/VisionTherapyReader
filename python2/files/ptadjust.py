...
class AdjustMenu(Toplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.instructions_label = ttk.Label(self, text="Click on the colors you wish to adjust.", padding=(0,6,0,9))
        self.calibrate_purpteal_button = ttk.Button(self, text="Purple & Teal", takefocus=False, command=self.parent.adjust_purpleteal)
        self.calibrate_redblue_button = ttk.Button(self, text="Red & Blue", takefocus=False, command=self.parent.adjust_redblue)
...
class PTAdjustMenu(Toplevel):
    def __init__(self, parent):
        ...
        self.purple_label1 = ttk.Label(self.options_frame, text="Bar reader\nColor reader")
        self.purple_label2 = ttk.Label(self.options_frame, text="Bar 1\nText 1")
        self.purple_sep = ttk.Label(self.options_frame, text=" : \n : ")
        self.purple_button = Button(self.options_frame, background=self.color1, text="    ", command=self.purple_click)

        self.teal_label1 = ttk.Label(self.options_frame, text="Bar reader\nColor reader")
        self.teal_label2 = ttk.Label(self.options_frame, text="Bar 2\nText 2")
        self.teal_sep = ttk.Label(self.options_frame, text=" : \n : ")
        ...
        self.gray_label2 = ttk.Label(self.options_frame, text="Text\nBackground")
        ...
        self.black_label2 = ttk.Label(self.options_frame, text="Background\nAnchor Text")
        ...
        self.purple_space = ttk.Label(self.options_frame, text=" ", font="Times 3")
