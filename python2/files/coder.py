...
class AskPassword(Toplevel):
    def __init__(self, parent):
        ...
        self.label = ttk.Label(self, text="Enter config code:")
        self.entry = ttk.Entry(self, width=11)
        self.problem_label = ttk.Label(self, text="Invalid config code. Please try again.", foreground="red")
        self.blank_label = ttk.Label(self, text=" ")
        self.okbutton = ttk.Button(self, text="OK", takefocus=False, command=self.ok_click)
        self.cancelbutton = ttk.Button(self, text="Cancel", takefocus=False, command=self.destroy)
...
class RetrievePassWord(Toplevel):
    def __init__(self, parent):
        ...
        self.label = ttk.Label(self, text="The config code for the\ncurrent configuration is:")
        self.entry = ttk.Entry(self, width=11)
        self.entry.insert(0, self.encode())
        self.entry.configure(state="readonly")
        self.button = ttk.Button(self, text="OK", command=lambda:self.destroy())
