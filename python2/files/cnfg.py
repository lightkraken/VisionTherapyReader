...
class QuitDialogue(Toplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.label = ttk.Label(self, text="Save current settings?")
        self.save_button = ttk.Button(self, text="Save", takefocus=False, command=self.save_new_config)
        self.dont_save_button = ttk.Button(self, text="Don't save", takefocus=False, command=self.parent.destroy)
        self.cancel_button = ttk.Button(self, text="Cancel", takefocus=False, command=self.destroy)
    ...
    def save_new_config(self):
        ...
        for key, value in END_OPTIONS.items():
