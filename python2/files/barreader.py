...
class BarReaderFrame(ttk.Frame):
...
class BarsBottomOptionsFrame(ttk.Frame):
    def __init__(self, *args, **kwargs):
        ttk.Frame.__init__(self, *args, **kwargs)
        ...
        # bar options frame
        self.bar_options_frame = ttk.LabelFrame(self, text="Bar", padding=3)
        ...
        self.bar_width_label = ttk.Label(self.bar_options_frame, text="Width:")
        ...
        self.bar_spacing_label = ttk.Label(self.bar_options_frame, text="Spacing:")
